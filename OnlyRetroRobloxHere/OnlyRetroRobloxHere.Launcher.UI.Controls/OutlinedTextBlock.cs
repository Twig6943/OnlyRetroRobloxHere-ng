...
public class OutlinedTextBlock : FrameworkElement
{
	...
	public static readonly DependencyProperty StrokeThicknessProperty = DependencyProperty.Register("StrokeThickness", typeof(double), typeof(OutlinedTextBlock), new FrameworkPropertyMetadata(1.0, FrameworkPropertyMetadataOptions.AffectsRender, StrokePropertyChangedCallback));
	...
	protected override Size MeasureOverride(Size availableSize)
	{
		...
		_FormattedText.MaxTextWidth = Math.Min(3579139.0, width);
		_FormattedText.MaxTextHeight = Math.Max(0.0001, height);
	...
	{
		OutlinedTextBlock obj = (OutlinedTextBlock)dependencyObject;
		obj._FormattedText = null;
		obj._TextGeometry = null;
	...
	private void EnsureFormattedText()
	{
		...
		{
			_FormattedText = new FormattedText(Text ?? "", CultureInfo.CurrentUICulture, base.FlowDirection, new Typeface(FontFamily, FontStyle, FontWeight, FontStretch), FontSize, Brushes.Black);
			UpdateFormattedText();
		}
	}
	...
	private void EnsureGeometry()
	{
		...
		{
			EnsureFormattedText();
			_TextGeometry = _FormattedText.BuildGeometry(new Point(0.0, 0.0));
		}
	}
}
